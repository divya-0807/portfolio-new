...
export const Timeline = ({
  ...
  return (
    <div
      ...
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 -mb-20">
        <h2 className="text-lg font-bold -mb-16 md:text-4xl  text-black dark:text-white max-w-4xl">
          Experience
        </h2>
