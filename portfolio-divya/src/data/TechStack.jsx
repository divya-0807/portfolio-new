...
export const techStack = [
  {
    ...
    stack: [
      ...
      { label: "GSAP", icon: <MdAnimation className="text-3xl hover:text-[#3F51B5]" /> },
    ],
  },
  {
    heading: "Backend",
    stack: [
      ...
      { label: "Mongoose", icon: <SiMongoosedotws className="text-3xl hover:text-[#f89820]" /> },
    ],
  },
  {
    heading: "Database",
  ...
  },
  {
    ...
    stack: [
      ...
      { label: "Java", icon: <FaJava className="text-3xl hover:text-[#FF9900]" /> },
    ],
  },
  {
    heading: "Creative",
